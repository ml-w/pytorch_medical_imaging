...
# def main():
#     indir = "./SBL_2D_3D/90.Testing/raw/"
#     dirs = RecursiveListDir(2, indir)
#     outdir = "./SBL_2D_3D/90.Testing/raw/"
#
#     for d in dirs:
#         reader = sitk.ImageSeriesReader()
#         if len(reader.GetGDCMSeriesIDs(d)) != 0:
#             outname = outdir + "/" + d.replace(indir, '')[1:].replace('/', '_').replace('/_', '') + ".nii.gz"
...
"""
def main():
    dir = "./SBL_2D_3D/90.Testing/COR/"
    f = os.listdir(dir)
    ftarget = fnmatch.filter(f, "*T1_COR*")
...
"""
Recursively resample images with another directory as reference
"""
# def main():
