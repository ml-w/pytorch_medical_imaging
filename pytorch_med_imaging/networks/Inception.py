...
Credit:
- The code was copied directly from https://github.com/weiaicunzai/pytorch-cifar100/blob/master/models/inceptionv4.py

License:
- No licences requirements were listed on the original repository as of 2022/05/05
...
__all__ = ['InceptionV4', 'InceptionResNetV2', 'InceptionV4_no_out']
...
class InceptionV4_no_out(nn.Module):
    def __init__(self, A, B, C, k=192, l=224, m=256, n=384):
