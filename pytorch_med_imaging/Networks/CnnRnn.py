...
class CNNGRU(nn.Module):
    ...
    Args:
        ...
        embeding_size (list or tuple, Optional):
            ...
            flattened before moving on into the GRU phase. Defaul to `(5,5)` (25-element vector)
    ...
    Examples:
        ...
        >>> import torch
        >>> net = CNNGRU(1, 3)
        >>> in_tensor = torch.rand(size=[1, 1, 22, 444, 444])
        >>> net = net.cuda()
    ...
    def __init__(self,
        ...
        self._config = {
            ...
            'embeding_size': torch.Tensor(embeding_size),
